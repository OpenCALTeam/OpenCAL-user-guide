...
%% Many examples are also included into the distribution.
...
%% Libraries can be compiled both statically (as .lib files) and as
%% shared objects (as .so files).
...
In the latter case you need to specify where include files are located by using the following command:
