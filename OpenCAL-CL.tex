...
define OpenCL platform and device to be considered for execution. In
...
(contained in the directory specified at line 3), compile and groups
...
the number of cells i the CA cellular space, while lines 11-12 get the
...
Lines 18-24 implement the life's transition roule. Note that, the the
