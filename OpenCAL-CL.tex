...
\lstinputlisting[label=lst:calcl_gl_sciddicaT, caption=An OpenCAL-CL
  ...
  for landslide
  simulation.]{../opencal/OpenCAL-CL/examples/calcl_gl_sciddicaT/source/sciddicaT.c}
...
\lstinputlisting[label=lst:calcl_gl_sciddicaT_kernels_header, caption={The SciddicaT
  ...
  OpenCAL-CL.}]{../opencal/OpenCAL-CL/examples/calcl_gl_sciddicaT/kernelActive/include/kernel.h}
...
\lstinputlisting[label=lst:calcl_gl_sciddicaT_kernels, caption=The OpenCAL-CL
  ...
  steering.]{../opencal/OpenCAL-CL/examples/calcl_gl_sciddicaT/kernelActive/source/kernel_user.cl}
...
\lstinputlisting[label=lst:calcl_gl_mod2, caption=An OpenCAL-CL
  ...
  output.]{../opencal/OpenCAL-CL/examples/calcl_gl_mod2CA3D/source/mod2CA3D.c}

\lstinputlisting[label=lst:calcl_gl_mod2_kernel, caption=The OpenCAL-CL
  kernel implementing the mod2 3D CA elementary
  process.]{../opencal/OpenCAL-CL/examples/calcl_gl_mod2CA3D/kernel/source/mod2CA.cl}
