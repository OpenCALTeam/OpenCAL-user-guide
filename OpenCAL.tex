...
Lines 220-222 of Listing \ref{lst:calgl_sciddicaT} define a frther
...
the previously defined \verb'draw_model3D' object. A legend is also defined at line 222.

Lines 224-225 set how the defined view have to be aranged within the
window, by means of the \verb'calglSetLayoutOrientation2D()' function. In this case ???

Lines 227 enters the graphic main loop thanks to the
...
visualization (line 214) and then adding the interval [300,
  \verb'draw_model3D->calModel->columns']. Similarly, line 2016 hides
