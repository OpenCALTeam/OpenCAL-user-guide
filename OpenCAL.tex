...
CPU was used. The simulation lasted a total of 22 seconds, versus 172
seconds obtained for the naive version, which is about 8 times
...
As noted, the definitions of the model and the simulation objects does
...
\begin{table}
  ...
  \begin{tabular}{l|c|c}
    ...
    \hline
    $SciddicaT_{naive}$      & 172 & 1\\
    $SciddicaT_{ac}$         & 22  & 7.8\\
    $SciddicaT_{ac+dnu}$     & 11  & 15.6\\
    $SciddicaT_{ac+dnu+esl}$  & 12  & 14.4\\
    \hline
  \end{tabular}
