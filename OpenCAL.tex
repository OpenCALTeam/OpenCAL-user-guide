...
and adopted conventions, a simple 2D CA is implemented and the main
structure of the library presented. Subsequently, four different
implementations of a more complex 2D example are illustrated, to show
simulation efficiency can be improved. The implementation of a simple
3D CA is also presented for the sake of completeness. The last part of
the Chapter deals with OpenCAL-GL and shows how to integrate a basic
OpenGL/GLUT visualization system in both 2D and 3D OpenCAL-based
applications.
...
As can be seen, data types have the same \verb'CAL' prefix, and an
