...
\emph{mod2} CA, by adding them an OpenGL (compatibility profile) based
visualizer in a straightforward manner. The visualization system
provided by OpenCAL-GL is however rather simplyfied and therefore, if
you need a more sophisticated graphic system you have to develop an
alternative by yourself.

\subsection{Implementing SciddicaT in OpenCAL and OpenCAL-GL}

\lstinputlisting[label=lst:calgl_sciddicaT, caption=An OpenCAL implementation of the sciddicaT 3D CA with openCAL-GL graphic output.]{../opencal/OpenCAL-GL/examples/calgl_sciddicaT/source/sciddicaT.c}
